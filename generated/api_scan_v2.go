...
// ScanV2ApiService ScanV2Api service
type ScanV2ApiService service
...
*/
func (a *ScanV2ApiService) ScanPayloadV2(ctx _context.Context, scanReqV2 ScanRequestV2) ([][]ScanResponseV2, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v2/scan"
